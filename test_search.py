...
def index_txt_file():
    ...
    correct_map['learned'] = [posting(3, [2])]
    correct_map['the'] = [posting(3, [3]), posting(5, [2])]
    correct_map['meaning'] = [posting(3, [4])]
    ...
    correct_map['else'] = [posting(5, [5])]
    correct_map['asian'] = [posting(5, [6])]
    correct_map['driver'] = [posting(5, [7])]
    correct_map['survivors'] = [posting(5, [9])]
